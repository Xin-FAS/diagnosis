...
<template>
    <view class="nav">
        <!-- 状态栏 -->
        <view :style="{ height: statusBarHeight + 'rpx', background }" />
        <!-- 内容区 -->
        <view
            v-if="isHome"
            class="home__head-nav"
            :style="{
                height: navHeight + 'rpx',
                lineHeight: navHeight + 'rpx',
                paddingLeft: '20rpx'
            }"
        >
            ...
            <view style="flex: 1">
                <navigator
                    ...
                    :style="{
                        ...
                        marginTop: menu.top * 2 - statusBarHeight + 'rpx',
                        marginLeft: '32rpx',
                ...
                >
                    <text class="search-text">找医院12</text>
                </navigator>
            </view>
        </view>
        <view
